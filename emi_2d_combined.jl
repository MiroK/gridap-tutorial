...
We end up with a perturbed saddle point problem
"""
function emi(model, parameters, data)
    ...
    # We consider only pressure bcs which will be here enforced weakly
    dir_tags1 = ["top", "top_left", "top_right"]
    Γ1 = BoundaryTriangulation(Ω₁, tags=dir_tags1)
